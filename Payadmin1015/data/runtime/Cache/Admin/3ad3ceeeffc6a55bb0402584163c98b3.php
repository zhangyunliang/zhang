		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts" >
					<a class="btn btn-small btn-success" href="javascript:openapp('<?php echo u('portal/recharge/index');?>','Recharge_index','充值订单列表');" title="充值订单列表">
						<i class="fa fa-th"></i>
					</a>
					
					<a class="btn btn-small btn-info" href="javascript:openapp('<?php echo u('portal/admin_page/index');?>','AdminPage_index','商品订单列表');" title="商品订单列表">
						<i class="fa fa-pencil"></i>
					</a>

					<a class="btn btn-small btn-warning" href="javascript:openapp('<?php echo u('Comment/commentadmin/index');?>','Comment_index','订单统计');" title="订单统计" >
						<i class="fa fa-list-alt"></i>
					</a>

					<a class="btn btn-small btn-danger" href="javascript:openapp('<?php echo u('admin/setting/clearexpireorder');?>','index_clearexpireorder','清除过期订单');" title="清除过期订单">
