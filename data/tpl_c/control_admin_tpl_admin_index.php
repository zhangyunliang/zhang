...
$("#show_much").hide(); 
    ...
    <div class="user_box">
        ...
        <div class="link_bar">
        	<a href="javascript:;" class="lock" onclick="fresh();" title="<?php echo $_lang['lock'];?>">刷新</a> 
         	<a href="javascript:;" class="lock" onclick="del_cache();" title="<?php echo $_lang['lock'];?>">清除缓存</a> 
