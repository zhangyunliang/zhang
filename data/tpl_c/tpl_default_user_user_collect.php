<?php keke_tpl_class::checkrefresh('tpl/default/user/user_collect', '1465984395' );?><?php if($_K['inajax']) { ?>
                    ...
                    <div class="panel clearfix box">
                        ...
                        <div class="grid_21">
                            ...
                            <header class="clearfix box_header">
                                <h2 class="grid_4 alpha box_title t_c"><?php echo $title;?></h2>
                                        ...
                                        <form action="<?php echo $url;?>#userCenter" method="post" id="frm">
                                            ...
                                            <div class="rowElem clearfix">
                                                <div class="mr_10 fl_l">
                                                    <input type="text" name="f_id" class="togg_u txt_input" value="<?php echo $_lang['please_enter_the_collection_num'];?>" title="<?php echo $_lang['please_enter_the_collection_num'];?>" size="5" style="width:140px;"/>
                                                </div>
                                                <div class="mr_10 fl_l">
                                                    <input type="text" name="obj_name" class="togg_u txt_input" value="<?php echo $_lang['please_enter_the_collection_name'];?>" title="<?php echo $_lang['please_enter_the_collection_name'];?>" style="width:150px;"/>
                                                </div>
                                                <div class="fl_l">
                                                    <select class="fl_l" name="ord">
                                                        <?php if(is_array($ord_arr)) { foreach($ord_arr as $k => $v) { ?><option value="<?php echo $k;?>" <?php if($ord==$k) { ?>selected="selected"<?php } ?>><?php echo $v;?> </option>
                                                        <?php } } ?>
                                                    </select>
                                                </div>
                                                <div class="mr_10 fl_l">
                                                ...
                                                <div class="fl_r">
                                                    <button type="submit" class="block" name="sbt_search" value="<?php echo $_lang['search'];?>" onclick="check('frm');"><span class="icon magnifier"></span><?php echo $_lang['search'];?></button>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <div class="data_list mt_10">
                                            <table cellpadding="0" cellspacing="0" class="data_table">
                                                <thead>
                                                    <tr>
                                                        <th scope="col">
                                                            <?php echo $_lang['collection_num'];?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $_lang['collection_name'];?>
                                                        </th>
                                                        <th scope="col">
                                                            <?php echo $_lang['collection_time'];?>
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                           <?php if($favor_arr) { ?>
                                            <?php if(is_array($favor_arr)) { foreach($favor_arr as $v) { ?>
                                                    <tr>
                                                    <td>
                                                        <?php echo $v['f_id']?>
                                                    </td>
                                                    <td>
                                                        <?php if($v['keep_type']=='task') { ?><a href="index.php?do=task&task_id=<?php echo $v['obj_id'];?>" title="<?php echo $v['obj_name']?>" target="_blank"><?php echo $model_name_arr[$v['obj_type']]['model_name']?>&nbsp;&nbsp;<?php echo $v['obj_name']?></a>
                                                    </td>
                                                    <?php } elseif($v['keep_type']=='work') { ?><a href="index.php?do=task&task_id=<?php echo $v['origin_id'];?>&view=work#work_<?php echo $v['obj_id'];?>" title="<?php echo $v['obj_name']?>" target="_blank"><?php echo $model_name_arr[$v['obj_type']]['model_name']?>&nbsp;&nbsp;<?php echo $v['obj_name']?></a>
                                                    </td>
                                                    <?php } elseif($v['keep_type']=='service') { ?><a href="index.php?do=service&sid=<?php echo $v['obj_id'];?>" title="<?php echo $v['obj_name']?>" target="_blank"><?php echo $model_name_arr[$v['obj_type']]['model_name']?>&nbsp;&nbsp;<?php echo $v['obj_name']?></a>
                                                </td>
  <?php } elseif($v['keep_type']=='shop') { ?><a href="index.php?do=space&member_id=<?php echo $v['obj_id'];?>" title="<?php echo $v['obj_name']?>" target="_blank"><?php echo $v['obj_name']?></a>
                                                </td>
                                                <?php } ?>
                                                <td>
                                                    <?php if($v['on_date']){echo date('Y-m-d',$v['on_date']); } ?>
                                                </td>
                                            </tr>
                                            <?php } } ?>
                                            <?php } else { ?>
