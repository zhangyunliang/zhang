<?php keke_tpl_class::checkrefresh('tpl/default/user/user_space_notice', '1465984388' );?><?php if($_K['inajax']) { ?>
       ...
       <div class="prefix_1 suffix_1">
         <div class="clearfix box market font14"> 
                  <div class="suffix_1 clearfix  pb_20 pt_10">
                     <div class="shops"><?php echo $_lang['had_not_open_shop'];?></div>
                     <div class="memb">
                     	<div class="hao"><?php echo $_lang['had'];?><?php echo $has_open_shop;?><?php echo $_lang['open_shop'];?></div >
<div class="air">
<div class="air"><?php echo $_lang['shop_desc'];?></div>
    </div>
<div  class="air"><?php echo $_lang['welcome_open_shop'];?></div > 
<div class="grid_10 t_l mt_20 alpha omega">
<button class="grid_3 alpha omega" onclick="open_shop();" value="<?php echo $_lang['hurry_open'];?>" type="submit"><?php echo $_lang['hurry_open'];?></button>
...
<script type="text/javascript">
   var space_desc = '<?php echo $space_desc?>';
   function open_shop(){  
   	if(space_desc){
showDialog(space_desc,"confirm","<?php echo $_lang['friendly_notice'];?>",function (){
location.href='<?php echo $url?>';
});return false;
}else{
location.href='index.php?do=user&view=setting&op=space&ac=open'; 
}
