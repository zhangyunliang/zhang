...
class GoodsAction extends CommonAction {
    ...
    private $create_fields = array('title', 'shop_id', 'photo', 'cate_id', 'price', 'mall_price','settlement_price', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby');
    private $edit_fields = array('title', 'shop_id', 'photo', 'cate_id', 'price', 'mall_price','settlement_price', 'commission', 'sold_num', 'orderby', 'views', 'instructions', 'details', 'end_date', 'orderby');
