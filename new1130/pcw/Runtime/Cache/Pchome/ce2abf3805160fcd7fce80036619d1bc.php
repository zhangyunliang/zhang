...
<div class="menu_fllist2">
    ...
    <?php if(is_array($tuancates)): foreach($tuancates as $key=>$item): if(($item["parent_id"]) == "0"): $i++;if($i <= 10){ ?>
        <div <?php if($i == 1): ?>class="item2 bo"<?php else: ?>class="item2"<?php endif; ?> >
            ...
            <div style="height: 407px;" class="menu_flklist2">
        ...
        <?php } endif; endforeach; endif; ?>
                ...
                <li class="navLi"><a <?php if($ctl == 'mall'): ?>class="navA  on"<?php else: ?>class="navA"<?php endif; ?> title="同城优购" href="<?php echo U('pchome/mall/main');?>" >同城优购</a></li>
